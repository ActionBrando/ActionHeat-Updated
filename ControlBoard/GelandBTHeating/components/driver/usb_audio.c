...
uint8_t USB_HID_Audio_ReportDesc[] =
    {
        ...
        0x0A,
        0xEA,
        0x00, /* Volume Decrement    */
        0x0A,
        0xE9,
        0x00, /* Volume Increment    */
        0x0A,
        0xB6,
        0x00, /* Scan Previous Track */
        0x0A,
        0xCD,
        0x00, /* Play/Pause          */
        0x0A,
        0xB5,
        0x00, /* Scan Next Track     */
        0x0A,
        0xB7,
        0x00, /* STOP                */
        0x0A,
...
static void usb_Audio_SetControl(void)
{
    ...
    case AUDIO_SET_VOL_SPEAKER:
        usb_read_fifo(ENDPOINT_0, (uint8_t *)&gu16_VolumeSpeaker, lu8_RxCount);
        break;
    case AUDIO_SET_VOL_MIC:
        usb_read_fifo(ENDPOINT_0, (uint8_t *)&gu16_VolumeMic, lu8_RxCount);
        break;
    case AUDIO_SET_MUTE_SPEAKER:
        usb_read_fifo(ENDPOINT_0, (uint8_t *)&gu8_MuteSpeaker, lu8_RxCount);
        break;
    case AUDIO_SET_MUTE_MIC:
        usb_read_fifo(ENDPOINT_0, (uint8_t *)&gu8_MuteMic, lu8_RxCount);
        break;
