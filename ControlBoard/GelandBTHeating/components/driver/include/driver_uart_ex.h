...
#define __UART_FIFO_Enable(__UART__)                         \
    do                                                       \
    {                                                        \
        __UART__->FCR_Shadow |= 0x01;                        \
        __UART__->FCR_Shadow |= 0x08;                        \
        __UART__->UARTx->FCR_IID.FCR = __UART__->FCR_Shadow; \
    } while (0)
#define __UART_FIFO_Disable(__UART__)                        \
    do                                                       \
    {                                                        \
        __UART__->FCR_Shadow &= ~0x01;                       \
        __UART__->FCR_Shadow &= ~0x08;                       \
...
#define __UART_RxFIFO_THRESHOLD(__UART__, __LEVEL__)         \
    do                                                       \
    {                                                        \
        __UART__->FCR_Shadow &= ~0xC0;                       \
...
#define __UART_TxFIFO_THRESHOLD(__UART__, __LEVEL__)         \
    do                                                       \
    {                                                        \
        __UART__->FCR_Shadow &= ~0x30;                       \
...
#define __UART_INT_TXE_ENABLE_FE(__UARTx__) \
    do                                      \
    {                                       \
        __UARTx__->IER_DLH.IER.PTIME = 1;   \
        __UARTx__->IER_DLH.IER.ETBEI = 1;   \
    } while (0)
/* Tx empty interrupt and fifo disable */
#define __UART_INT_TXE_ENABLE_FD(__UARTx__) \
    do                                      \
    {                                       \
        __UARTx__->IER_DLH.IER.PTIME = 0;   \
        __UARTx__->IER_DLH.IER.ETBEI = 1;   \
    } while (0)
...
#define __UART_INT_TXE_DISABLE(__UARTx__) \
    do                                    \
    {                                     \
        __UARTx__->IER_DLH.IER.PTIME = 0; \
        __UARTx__->IER_DLH.IER.ETBEI = 0; \
    } while (0)
...
/* flow control config */
#define __UART_AUTO_FLOW_CONTROL_ENABLE(__UARTx__) \
    do                                             \
    {                                              \
        __UARTx__->MCR.AFCE = 1;                   \
        __UARTx__->MCR.RTS = 1;                    \
    } while (0)
