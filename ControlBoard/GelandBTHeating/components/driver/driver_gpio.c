...
void gpio_write_group(enum_GPIOx_t fe_GPIO, uint8_t fu8_GroupStatus)
{
    ...
    {
    case GPIO_A:
        GPIO->PortA_DATA = fu8_GroupStatus;
        break;
    case GPIO_B:
        GPIO->PortB_DATA = fu8_GroupStatus;
        break;
    case GPIO_C:
        GPIO->PortC_DATA = fu8_GroupStatus;
        break;
    case GPIO_D:
        GPIO->PortD_DATA = fu8_GroupStatus;
        break;
    case GPIO_E:
        GPIO->PortE_DATA = fu8_GroupStatus;
        break;
...
void gpio_write_pin(enum_GPIOx_t fe_GPIO, uint8_t fu8_Pin, enum_PinStatus_t fe_PinStatus)
{
    ...
    {
    case GPIO_A:
        GPIO->PortA_DATA = fe_PinStatus ? GPIO->PortA_DATA | fu8_Pin : GPIO->PortA_DATA & ~fu8_Pin;
        break;
    case GPIO_B:
        GPIO->PortB_DATA = fe_PinStatus ? GPIO->PortB_DATA | fu8_Pin : GPIO->PortB_DATA & ~fu8_Pin;
        break;
    case GPIO_C:
        GPIO->PortC_DATA = fe_PinStatus ? GPIO->PortC_DATA | fu8_Pin : GPIO->PortC_DATA & ~fu8_Pin;
        break;
    case GPIO_D:
        GPIO->PortD_DATA = fe_PinStatus ? GPIO->PortD_DATA | fu8_Pin : GPIO->PortD_DATA & ~fu8_Pin;
        break;
    case GPIO_E:
        GPIO->PortE_DATA = fe_PinStatus ? GPIO->PortE_DATA | fu8_Pin : GPIO->PortE_DATA & ~fu8_Pin;
        break;
...
uint8_t gpio_read_group(enum_GPIOx_t fe_GPIO)
{
    ...
    {
    case GPIO_A:
        lu8_PinStatus = GPIO->PortA_DATA;
        break;
    case GPIO_B:
        lu8_PinStatus = GPIO->PortB_DATA;
        break;
    case GPIO_C:
        lu8_PinStatus = GPIO->PortC_DATA;
        break;
    case GPIO_D:
        lu8_PinStatus = GPIO->PortD_DATA;
        break;
    case GPIO_E:
        lu8_PinStatus = GPIO->PortE_DATA;
        break;
...
enum_PinStatus_t gpio_read_pin(enum_GPIOx_t fe_GPIO, uint8_t fu8_Pin)
{
    ...
    {
    case GPIO_A:
        le_PinStatus = (GPIO->PortA_DATA & fu8_Pin) ? GPIO_PIN_SET : GPIO_PIN_CLEAR;
        break;
    case GPIO_B:
        le_PinStatus = (GPIO->PortB_DATA & fu8_Pin) ? GPIO_PIN_SET : GPIO_PIN_CLEAR;
        break;
    case GPIO_C:
        le_PinStatus = (GPIO->PortC_DATA & fu8_Pin) ? GPIO_PIN_SET : GPIO_PIN_CLEAR;
        break;
    case GPIO_D:
        le_PinStatus = (GPIO->PortD_DATA & fu8_Pin) ? GPIO_PIN_SET : GPIO_PIN_CLEAR;
        break;
    case GPIO_E:
        le_PinStatus = (GPIO->PortE_DATA & fu8_Pin) ? GPIO_PIN_SET : GPIO_PIN_CLEAR;
        break;
