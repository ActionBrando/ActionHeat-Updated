 ...
 * ÿһ���һ��characteristic attribute��Ӧ��UUID�Ķ��塣
 * ��һ����UUID�ĳ��ȣ�
 * ÿ������UUID��ֵ��
 */
...
void ANCS_recv_ntf_src(uint8_t conidx, uint8_t *p_data, uint16_t len)
{
    ...
    if ((ntf_src->category_id == CATGRY_ID_SOCIAL || ntf_src->category_id == CATGRY_ID_OTHER || ntf_src->category_id == CATGRY_ID_INCOMING_CALL || ntf_src->category_id == CATGRY_ID_EMAIL) &&
