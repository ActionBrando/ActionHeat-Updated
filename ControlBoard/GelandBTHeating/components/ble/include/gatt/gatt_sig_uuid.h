...
#define GATT_UUID_TREADMILL_DATA 0x2ACD     // �ܲ�������
#define GATT_UUID_CROSS_TRAINER_DATA 0x2ACE // ��Բ������
#define GATT_UUID_ROWER_DATA 0x2AD1         // ����������
#define GATT_UUID_INDOOR_BIKE_DATA 0x2AD2   // ��������
#define GATT_UUID_STEP_CLIMBER_DATA 0x2ACF  // ���һ�
#define GATT_UUID_STAIR_CLIMBER_DATA 0x2AD0 // ��¥�ݻ�
