...
void i2c_clear_int_status(I2C_HandleTypeDef *hi2c, enum_INT_Index_t fe_INT_Index)
{
    ...
    {
    case INT_RX_UNDER:
        lu32_Temp = hi2c->I2Cx->CLR_RX_UNDER;
        break;
    case INT_RX_OVER:
        lu32_Temp = hi2c->I2Cx->CLR_RX_OVER;
        break;
    case INT_TX_OVER:
        lu32_Temp = hi2c->I2Cx->CLR_TX_OVER;
        break;
    case INT_RD_REQ:
        lu32_Temp = hi2c->I2Cx->CLR_RD_REQ;
        break;
    case INT_TX_ABRT:
        lu32_Temp = hi2c->I2Cx->CLR_TX_ABRT;
        break;
    case INT_RX_DONE:
        lu32_Temp = hi2c->I2Cx->CLR_RX_DONE;
        break;
    case INT_ACTIVITY:
        lu32_Temp = hi2c->I2Cx->CLR_ACTIVITY;
        break;
    case INT_STOP_DET:
        lu32_Temp = hi2c->I2Cx->CLR_STOP_DET;
        break;
    case INT_START_DET:
        lu32_Temp = hi2c->I2Cx->CLR_START_DET;
        break;
    case INT_RESTART_DET:
        lu32_Temp = hi2c->I2Cx->CLR_RESTART_DET;
        break;
    case INT_SCL_STUCK_AT_LOW:
        lu32_Temp = hi2c->I2Cx->CLR_SCL_STUCK_DET;
        break;
