...
void adc_int_enable(enum_int_t fe_INT)
{
    ...
    {
    case FIFO_FULL_INT:
        ADC->INT.FIFO_FULL_INT = 1;
        break;
    case FIFO_EMPTY_INT:
        ADC->INT.FIFO_EMPTY_INT = 1;
        break;
    case FIFO_ALMOST_FULL_INT:
        ADC->INT.FIFO_ALMOST_FULL_INT = 1;
        break;
    case FIFO_OVER_INT:
        ADC->INT.FIFO_OVER_INT = 1;
        break;
    case FIFO_UNDER_INT:
        ADC->INT.FIFO_UNDER_INT = 1;
        break;
    case ERR_INT:
        ADC->INT.ERR_INT = 1;
        break;
...
void adc_int_disable(enum_int_t fe_INT)
{
    ...
    {
    case FIFO_FULL_INT:
        ADC->INT.FIFO_FULL_INT = 0;
        break;
    case FIFO_EMPTY_INT:
        ADC->INT.FIFO_EMPTY_INT = 0;
        break;
    case FIFO_ALMOST_FULL_INT:
        ADC->INT.FIFO_ALMOST_FULL_INT = 0;
        break;
    case FIFO_OVER_INT:
        ADC->INT.FIFO_OVER_INT = 0;
        break;
    case FIFO_UNDER_INT:
        ADC->INT.FIFO_UNDER_INT = 0;
        break;
    case ERR_INT:
        ADC->INT.ERR_INT = 0;
        break;
...
bool adc_get_int_status(enum_int_t fe_INT)
{
    ...
    {
    case FIFO_FULL_INT:
        lb_Status = ADC->INT.FIFO_FULL_STATUS;
        break;
    case FIFO_EMPTY_INT:
        lb_Status = ADC->INT.FIFO_EMPTY_STATUS;
        break;
    case FIFO_ALMOST_FULL_INT:
        lb_Status = ADC->INT.FIFO_ALMOST_FULL_STATUS;
        break;
    case FIFO_OVER_INT:
        lb_Status = ADC->INT.FIFO_OVER_STATUS;
        break;
    case FIFO_UNDER_INT:
        lb_Status = ADC->INT.FIFO_UNDER_STATUS;
        break;
    case ERR_INT:
        lb_Status = ADC->INT.ERR_STATUS;
        break;
    case SW_INT:
        lb_Status = ADC->INT.SW_STATUS;
        break;
...
void adc_clr_int_status(enum_int_t fe_INT)
{
    ...
    {
    case FIFO_FULL_INT:
        ADC->INTC.FIFO_FULL_CLR = 1;
        break;
    case FIFO_EMPTY_INT:
        ADC->INTC.FIFO_EMPTY_CLR = 1;
        break;
    case FIFO_ALMOST_FULL_INT:
        ADC->INTC.FIFO_ALMOST_FULL_CLR = 1;
        break;
    case FIFO_OVER_INT:
        ADC->INTC.FIFO_OVER_CLR = 1;
        break;
    case FIFO_UNDER_INT:
        ADC->INTC.FIFO_UNDER_CLR = 1;
        break;
    case ERR_INT:
        ADC->INTC.ERR_CLR = 1;
        break;
