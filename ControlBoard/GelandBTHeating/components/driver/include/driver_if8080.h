...
static inline void if8080_interrupt_enable(enum_INT_t fe_INT_Index)
{
    ...
    {
    case INT_HSYNC:
        IF8080->INT.TE_HSYNC_INT_ENABLE = 1;
        break;
    case INT_VSYNC:
        IF8080->INT.TE_VSYNC_INT_ENABLE = 1;
        break;
    case INT_AEMPT:
        IF8080->INT.TX_AEMPT_INT_ENABLE = 1;
        break;
    case INT_EMPTY:
        IF8080->INT.TX_EMPT_INT_ENABLE = 1;
        break;
    case INT_FULL:
        IF8080->INT.TX_FULL_INT_ENABLE = 1;
        break;
...
static inline bool if8080_interrupt_get_status(enum_INT_t fe_INT_Index)
{
    ...
    {
    case INT_HSYNC:
        return IF8080->INT.TE_HSYNC_INT_STATUS;
    case INT_VSYNC:
        return IF8080->INT.TE_VSYNC_INT_STATUS;
    case INT_AEMPT:
        return IF8080->INT.TX_AEMPT_INT_STATUS;
    case INT_EMPTY:
        return IF8080->INT.TX_EMPT_INT_STATUS;
    case INT_FULL:
        return IF8080->INT.TX_FULL_INT_STATUS;
...
static inline void if8080_interrupt_clear_status(enum_INT_t fe_INT_Index)
{
    ...
    {
    case INT_HSYNC:
        IF8080->INT.TE_HSYNC_INT_CLEAR = 1;
    case INT_VSYNC:
        IF8080->INT.TE_VSYNC_INT_CLEAR = 1;
