...
// #define LED_LEVEL_NONE                      0
#define LED_LEVEL_LOW 0
#define LED_LEVEL_MEDIUM 1
#define LED_LEVEL_HIGH 2
#define LED_LEVEL_DEFAULT LED_LEVEL_HIGH

// 0- outerwear 1-Pants 2-Footwear 3-Gloves 4-Accessories
#define DEVICE_TYPE 0

// main.c image_size * 2 = 0x32000, so customer address start with it
#define CUS_NAME_ADDR 0x32100
#define CUS_LEN_ADDR 0x321F0
